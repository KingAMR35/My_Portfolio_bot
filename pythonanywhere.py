...
<blockquote>Перед вами бот, превращающий <strong>текст в аудио!</strong> Просто отправьте текст, и получите голосовое сообщение с идеальной дикцией и четкостью звука.</blockquote>
